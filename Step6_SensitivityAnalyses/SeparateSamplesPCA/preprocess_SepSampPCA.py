...
"""
phenotypes = pd.read_csv('/gpfs/fs001/cbica/projects/abcdfnets/data_for_ridge_SepSampPCA.csv') #load
...
phenotypes[['SepSampPC1','SepSampPC2','SepSampPC3','rel_family_id','matched_group']].to_csv('/{0}/phenotypes_target.csv'.format(outdir))
