...
"""
phenotypes = pd.read_csv('/gpfs/fs001/cbica/projects/abcdfnets/data_for_ridge_IndTask.csv') #load
...
phenotypes[['PicVocab','Flanker','Pattern','Reading','Picture','List','CardSort','LMT','RAVLT','rel_family_id','matched_group']].to_csv('/{0}/phenotypes_target.csv'.format(outdir))
