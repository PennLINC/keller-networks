...
abcd.data.for.ridge<-abcd.data.traintest[,c("subjectkey","thompson_PC1","thompson_PC2","thompson_PC3","matched_group","interview_age","sex","meanFD","abcd_site","rel_family_id","reshist_addr1_adi_income")]
abcd.data.for.ridge.complete<-abcd.data.for.ridge[complete.cases(abcd.data.for.ridge),]

ses.data.for.ridge<-abcd.data.for.ridge.complete[,c("subjectkey","reshist_addr1_adi_income")]

write.csv(abcd.data.for.ridge.complete,"/Users/askeller/Documents/Kellernet_PrelimAnalysis/data_for_ridge_SES.csv")
write.csv(ses.data.for.ridge,"/Users/askeller/Documents/Kellernet_PrelimAnalysis/SES_features.csv")
