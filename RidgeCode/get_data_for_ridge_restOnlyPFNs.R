...
pfn_sizes <- read.csv("/Users/askeller/Documents/Kellernet_PrelimAnalysis/All_PFN_sizes_Rest_081122.csv")
...
write.csv(abcd.data.for.ridge.complete,"/Users/askeller/Documents/Kellernet_PrelimAnalysis/data_for_ridge_Rest_081122.csv")
