...
%% Replot the scatterplots as hexplots

figure()

subplot(2,3,1)
hexscatter(actual_PC1_samp1,pred_PC1_samp1,'res',40)
hold on
linearFit = polyfit(actual_PC1_samp1,pred_PC1_samp1,1);
hline = refline(linearFit);
hline.Color=color_fill_1;
hline.LineWidth=3;
colormap("hot")
xlabel("Actual Cognitive Performance",'FontSize',12)
ylabel("Predicted Cognitive Performance",'FontSize',12)
axis([-4 4 -4 4])

subplot(2,3,4)
hexscatter(actual_PC1_samp2,pred_PC1_samp2,'res',40)
hold on
linearFit = polyfit(actual_PC1_samp2,pred_PC1_samp2,1);
hline = refline(linearFit);
hline.Color=color_fill_1;
...
subplot(2,3,2)
hexscatter(actual_PC2_samp1,pred_PC2_samp1,'res',40)
hold on
linearFit = polyfit(actual_PC2_samp1,pred_PC2_samp1,1);
hline = refline(linearFit);
hline.Color=color_fill_1;
...
subplot(2,3,5)
hexscatter(actual_PC2_samp2,pred_PC2_samp2,'res',40)
hold on
linearFit = polyfit(actual_PC2_samp2,pred_PC2_samp2,1);
hline = refline(linearFit);
hline.Color=color_fill_1;
...
subplot(2,3,3)
hexscatter(actual_PC3_samp1,pred_PC3_samp1,'res',40)
hold on
linearFit = polyfit(actual_PC3_samp1,pred_PC3_samp1,1);
hline = refline(linearFit);
hline.Color=color_fill_1;
...
subplot(2,3,6)
hexscatter(actual_PC3_samp2,pred_PC3_samp2,'res',40)
hold on
linearFit = polyfit(actual_PC3_samp2,pred_PC3_samp2,1);
hline = refline(linearFit);
hline.Color=color_fill_1;
...
%% Sensitivity analysis: Separate Samples PCA

% Load in prediction results
folder_name='/Users/askeller/Documents/Kellernet_PrelimAnalysis/RevisionAnalyses_PFNsCog/SeparateSamplesCognitionPCA/results/all_network';
file_name_pred1_samp1='SepSampPC1_prediction_testA.npy';
file_name_pred2_samp1='SepSampPC2_prediction_testA.npy';
file_name_pred3_samp1='SepSampPC3_prediction_testA.npy';
file_name_pred1_samp2='SepSampPC1_prediction_testB.npy';
file_name_pred2_samp2='SepSampPC2_prediction_testB.npy';
file_name_pred3_samp2='SepSampPC3_prediction_testB.npy';
pred_PC1_samp1 = readNPY([folder_name '/' file_name_pred1_samp1]);
pred_PC2_samp1 = readNPY([folder_name '/' file_name_pred2_samp1]);
pred_PC3_samp1 = readNPY([folder_name '/' file_name_pred3_samp1]);
pred_PC1_samp2 = readNPY([folder_name '/' file_name_pred1_samp2]);
...
% fourth column has the matched_group
data_for_ridge=xlsread('/Users/askeller/Documents/Kellernet_PrelimAnalysis/RevisionAnalyses_PFNsCog/SeparateSamplesCognitionPCA/data_for_ridge_SepSampPCA.xls');
...
% ~~~~~ NULL ~~~~~~ %
folder_name='/Users/askeller/Documents/Kellernet_PrelimAnalysis/RevisionAnalyses_PFNsCog/SeparateSamplesCognitionPCA/results/all_network_null/';
file_name_acc_PC1_null_samp1='SepSampPC1_acc_null_testA_group1.npy';
file_name_acc_PC1_null_samp2='SepSampPC1_acc_null_testB_group1.npy';
file_name_acc_PC2_null_samp1='SepSampPC2_acc_null_testA_group1.npy';
file_name_acc_PC2_null_samp2='SepSampPC2_acc_null_testB_group1.npy';
file_name_acc_PC3_null_samp1='SepSampPC3_acc_null_testA_group1.npy';
file_name_acc_PC3_null_samp2='SepSampPC3_acc_null_testB_group1.npy';
acc_PC1_null_samp1 = readNPY([folder_name '/' file_name_acc_PC1_null_samp1]);
acc_PC1_null_samp2 = readNPY([folder_name '/' file_name_acc_PC1_null_samp2]);
acc_PC2_null_samp1 = readNPY([folder_name '/' file_name_acc_PC2_null_samp1]);
acc_PC2_null_samp2 = readNPY([folder_name '/' file_name_acc_PC2_null_samp2]);
