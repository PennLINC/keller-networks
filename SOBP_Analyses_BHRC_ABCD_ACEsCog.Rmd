...
```{r}
summary(lmer(thompson_PC1~interview_age+sex+race_ethnicity+(1|rel_family_id)+totalACEs+totalACEs*sex,data=abcd.data))
summary(lmer(thompson_PC2~interview_age+sex+race_ethnicity+(1|rel_family_id)+totalACEs+totalACEs*sex,data=abcd.data))
summary(lmer(thompson_PC3~interview_age+sex+race_ethnicity+(1|rel_family_id)+totalACEs+totalACEs*sex,data=abcd.data))

summary(lmer(thompson_PC1~interview_age+sex+(1|rel_family_id)+abuse+abuse*sex,data=abcd.data))
summary(lmer(thompson_PC2~interview_age+sex+(1|rel_family_id)+abuse+abuse*sex,data=abcd.data))
summary(lmer(thompson_PC3~interview_age+sex+(1|rel_family_id)+abuse+abuse*sex,data=abcd.data))
```
