...
tmpdir = '/cbica/projects/abcdfnets/scripts/keller_ridge/pennlinc-regression/example_keller/tempfiles_matchedsamples_boot_null_081822/' #os.environ['TMPDIR']
...
for cog_score in ['thompson_PC1','thompson_PC2','thompson_PC3']:
        os.system('qsub -l h_vmem={0},s_vmem={0} -N {1} -R y -V -j y -b y -o ~/sge/ -e ~/sge/ python {2}/keller_proc_predict_boot_null.py {2} {3} {4} {5}'.format(GB,cog_score.split('_')[1],homedir,tmpdir,network,cog_score))
