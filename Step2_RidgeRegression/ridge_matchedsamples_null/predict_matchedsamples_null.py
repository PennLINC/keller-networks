...
np.save('/{0}/{1}_acc_null_testA_group1.npy'.format(working_dir,phenotype_name),accuracy_testA)
np.save('/{0}/{1}_acc_null_testB_group1.npy'.format(working_dir,phenotype_name),accuracy_testB)
