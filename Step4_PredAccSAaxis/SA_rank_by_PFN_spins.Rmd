...
#ggplot(data=df.acc.SA,aes(SArank_byPFN,predacc_PC1)) + geom_bar(stat="identity",fill=SArank_byPFN)
...
ggplot(data=df.acc.SA,aes(SArank_byPFN,predacc_PC1,color=SArank_byPFN)) + geom_point(size=3) + geom_smooth(method=lm,color='black') + theme_classic() +
  ...
  scale_color_gradient2(high = "#6f1282", mid = "#f9f7fa", low = "goldenrod1", aesthetics = "color", midpoint = 30000) + xlab("S-A Axis Rank") + ylab("Prediction Accuracy (General Cognition)")
dev.off()
...
ggplot(data=df.acc.SA,aes(SArank_byPFN,predacc_PC2,color=SArank_byPFN)) + geom_point(size=3) + geom_smooth(method=lm,color='black') + theme_classic() +
  theme(legend.position = "none", panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_color_gradient2(high = "#6f1282", mid = "#f9f7fa", low = "goldenrod1", aesthetics = "color", midpoint = 30000) + xlab("S-A Axis Rank") + ylab("Prediction Accuracy (Executive Function)")
dev.off()
...
ggplot(data=df.acc.SA,aes(SArank_byPFN,predacc_PC3,color=SArank_byPFN)) + geom_point(size=3) + geom_smooth(method=lm,color='black') + theme_classic() +
  theme(legend.position = "none", panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_color_gradient2(high = "#6f1282", mid = "#f9f7fa", low = "goldenrod1", aesthetics = "color", midpoint = 30000) + xlab("S-A Axis Rank") + ylab("Prediction Accuracy (Learning/Memory)")
dev.off()
...
ggplot(data=df.acc.SA,aes(SArank_byPFN,predacc_PC1,color=SArank_byPFN)) + geom_point(size=3) + geom_smooth(method=lm,color='black') + theme_classic() +
  theme(legend.position = "none", panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_color_gradient2(high = "#6f1282", mid = "#f9f7fa", low = "goldenrod1", aesthetics = "color", midpoint = 30000) + xlab("S-A Axis Rank") + ylab("Prediction Accuracy")
dev.off()
